...
class ActionProject extends Column
{

    const GRID_URL_PATH_EDIT = 'buildingmanager/project/edit';
    const GRID_URL_PATH_DELETE = 'buildingmanager/project/delete';
    /** @var UrlInterface */
                ...
                if (isset($item['id'])) {
                    ...
                    $item[$name]['delete'] = [
                        ...
                        'confirm' => [
                            ...
                            'message' => __('Bạn có muốn xóa "${ $.$data.name }"?')
                        ]
                    ];
                }
            }
